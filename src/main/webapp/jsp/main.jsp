...
<head>
	...
	// 			alert("父类节点无法点击哦...");
		...
		function loadMenu(resourceType, treeObj){
            ...
            {"accessPath":"jsp/house_list.jsp","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":7,"resourceName":"房源管理","resourceOrder":0,"resourceType":""},
...
<body onload="getDate01()">
    ...
    <div id="main">
      	<iframe name="right" id="rightMain" src="../testMaven/jsp/introduce.jsp" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true"/>
    </div>
